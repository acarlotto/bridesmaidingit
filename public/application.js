...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetEvents = function onGetEvents(event) {
	  event.preventDefault();
	  appApi.showEvent().then(appUi.onSuccessGetEvent).catch(appUi.onFailureGetEvent);
	};

	var onGetUsersEvents = function onGetUsersEvents(event_id) {
	  // console.log('events.js')
	  event.preventDefault();
	  appApi.showUserEvents(event_id).then(appUi.onSuccessGetUserEvent).catch(appUi.onFailureGetUserEvent);
	};
	...
	var onCreateNewEvent = function onCreateNewEvent() {
	  var data = getFormFields(this);
	  event.preventDefault();
	  appApi.newEvent(data).then(appUi.newSuccess).catch(appUi.newFail);
	};
	...
	var onDeleteEvent = function onDeleteEvent(event) {
	  ...
	  event.preventDefault();
	  appApi.deleteEvent(delete_id).then(appUi.deleteSuccess).catch(appUi.deleteFail);
	};
	...
	var updateEvent = function updateEvent(event) {
	  ...
	  // console.log(data)
	  event.preventDefault();
	  appApi.updateEvent(data, update_id).then(appUi.onUpdateSuccess).catch(appUi.onUpdateFail);
	};
	...
	module.exports = {
	  ...
	  onGetUsersEvents: onGetUsersEvents,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showUserEvents = function showUserEvents(event_id) {
	  // console.log('api')
	  return $.ajax({
